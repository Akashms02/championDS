...
function App() {
  return (
    <div className="bg-white text-gray-900 font-sans relative">
      ...
      >
        {/* Pulsing underlay glow */}
        <span className="absolute -inset-1 bg-[#25D366] rounded-full blur-md opacity-75 group-hover:opacity-100 animate-ping pointer-events-none"></span>
